export default function LinkedIn(){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="50" height="50"
            viewBox="0 0 48 48"
            className="fill-cyan-600 ease-out duration-200 hover:scale-125 hover:rounded-md hover:shadow-lg hover:fill-orange-500 hover:border-solid hover:border-red-500 hover:border-2"
        >
